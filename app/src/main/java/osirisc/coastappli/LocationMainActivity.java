...
public class LocationMainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        SectionsPagerAdapterLocation sectionsPagerAdapterLocation = new SectionsPagerAdapterLocation(this,
    ...
    public int getErosionDistanceMeasureBool(){ return erosionDistanceMeasureBool;}
    ...
    public void PhotoCaptureFunction(View view){
        ...
        myIntent.putExtra("erosionDistanceMeasureBool", erosionDistanceMeasureBool);
     ...
     * @param view
     */
    public void DistanceMeasureFunction(View view){
        Intent myIntent= new Intent(this, DistanceErosionMainActivity.class);
        myIntent.putExtra("markerLatitude", markerLatitude);
        myIntent.putExtra("markerLongitude", markerLongitude);
        myIntent.putExtra("nameBeach", nameBeach);
        myIntent.putExtra("nameTown", nameTown);
    ...
    /**
     * Function launched when clicking on the question icon in the indicators' fragment for the distance measurement
     * It launches a dialog explaining what the task is
     * @param view
     */
    public void onClickQuestionIconDistance(View view){
        final AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(this);

        //set title
        alertDialogBuilder.setTitle(getResources().getString(R.string.erosionSurface));
        alertDialogBuilder.setMessage(getResources().getString(R.string.questionIconDistance));
