...
import osirisc.coastappli.helper.DatabaseHandler;
import osirisc.coastappli.helper.Functions;
import osirisc.coastappli.helper.SessionManager;
...
public class HomeActivity extends AppCompatActivity {
    ...
    Button b1;
    private static final String TAG = osirisc.coastappli.HomeActivity.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        b1 = (Button)findViewById(R.id.button_validation);

        DatabaseHandler db = new DatabaseHandler(osirisc.coastappli.HomeActivity.this);
        user = db.getUserDetails();

        // session manager
        session = new SessionManager(osirisc.coastappli.HomeActivity.this);

        // if we clik on continue we launch the app
    ...
    private void init() {
        ...
        btnChangePass.setOnClickListener(v -> {
            final AlertDialog.Builder dialogBuilder = new AlertDialog.Builder(osirisc.coastappli.HomeActivity.this);
            ...
            alertDialog.setOnShowListener(dialog -> {
                ...
                b.setOnClickListener(view -> {
                    ...
                    if (!old_pass.isEmpty() && !new_pass.isEmpty()) {
                        ...
                        Toast.makeText(osirisc.coastappli.HomeActivity.this, "Fill all values!", Toast.LENGTH_SHORT).show();
                    }
    ...
    private void logoutUser() {
        ...
        logout.logoutUser(osirisc.coastappli.HomeActivity.this);
        Intent intent = new Intent(osirisc.coastappli.HomeActivity.this, LoginActivity.class);
        ...
        StringRequest strReq = new StringRequest(Request.Method.POST,
                Functions.RESET_PASS_URL, response -> {
                    ...
                    try {
                        ...
                        Toast.makeText(osirisc.coastappli.HomeActivity.this, jObj.getString("message"), Toast.LENGTH_LONG).show();

                    } catch (JSONException e) {
                        // JSON error
                        e.printStackTrace();
                        Toast.makeText(osirisc.coastappli.HomeActivity.this, e.getMessage(), Toast.LENGTH_LONG).show();
                    }
    
                }, error -> {
            Log.e(TAG, "Reset Password Error: " + error.getMessage());
            Toast.makeText(osirisc.coastappli.HomeActivity.this, error.getMessage(), Toast.LENGTH_LONG).show();
            hideDialog();
        }) {
    ...
    private void showDialog() {
        Functions.showProgressDialog(osirisc.coastappli.HomeActivity.this, "Please wait...");
    }

    private void hideDialog() {
        Functions.hideProgressDialog(osirisc.coastappli.HomeActivity.this);
    }
