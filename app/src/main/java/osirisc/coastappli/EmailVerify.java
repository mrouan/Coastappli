...
public class EmailVerify extends AppCompatActivity {
    private static final String TAG = osirisc.coastappli.EmailVerify.class.getSimpleName();
    ...
    private void init() {
        btnVerify.setOnClickListener(v -> {
            // Hide Keyboard
            Functions.hideSoftKeyboard(osirisc.coastappli.EmailVerify.this);
                ...
                Functions.OTP_VERIFY_URL, response -> {
                    ...
                    try {
                        ...
                        if (!error) {
                            ...
                            Intent upanel = new Intent(osirisc.coastappli.EmailVerify.this, HomeActivity.class);
    ...
    private void showDialog(String title) {
        Functions.showProgressDialog(osirisc.coastappli.EmailVerify.this, title);
    }

    private void hideDialog() {
        Functions.hideProgressDialog(osirisc.coastappli.EmailVerify.this);
    }
