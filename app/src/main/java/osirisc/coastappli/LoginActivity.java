...
public class LoginActivity extends AppCompatActivity {
    private static final String TAG = osirisc.coastappli.LoginActivity.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (session.isLoggedIn()) {
            Intent i = new Intent(osirisc.coastappli.LoginActivity.this, osirisc.coastappli.HomeActivity.class);
            startActivity(i);
            finish();
        }
    ...
    private void init() {
        ...
        btnLogin.setOnClickListener(view -> {
            // Hide Keyboard
            Functions.hideSoftKeyboard(osirisc.coastappli.LoginActivity.this);
        ...
        btnLinkToRegister.setOnClickListener(view -> {
            Intent i = new Intent(osirisc.coastappli.LoginActivity.this, RegisterActivity.class);
            startActivity(i);
        });
                    ...
                    try {
                        ...
                        if (!error) {
                            ...
                            if(Integer.parseInt(json_user.getString("verified")) == 1){
                                ...
                                Intent upanel = new Intent(osirisc.coastappli.LoginActivity.this, osirisc.coastappli.HomeActivity.class);
                                ...
                                Intent upanel = new Intent(osirisc.coastappli.LoginActivity.this, osirisc.coastappli.EmailVerify.class);
                                upanel.putExtras(b);
                                upanel.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                                startActivity(upanel);
                            }
    ...
    private void showDialog(String title) {
        Functions.showProgressDialog(osirisc.coastappli.LoginActivity.this, title);
    }

    private void hideDialog() {
        Functions.hideProgressDialog(osirisc.coastappli.LoginActivity.this);
    }
}
